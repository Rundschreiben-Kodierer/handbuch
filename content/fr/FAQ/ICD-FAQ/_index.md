...
Un herpès zoster se manifestant dans la zone d'innervation de la première branche du trijumeau est, par définition, un zona ophtalmique. Celui-ci est codé B02.3 <i>Zona ophtalmique</i> selon la CIM-10-GM 2024.
{{</markdown>}}
<br>  
<br>
{{</article>}}
...
**Recommandation de codage:**  
Si les symptômes/la dyspnée sont documentés de manière appropriée, les codes I50.12- I50.14 <i>Insuffisance cardiaque gauche avec symptômes (...)</i> ou les codes supplémentaires I50.02! - I50.05! <i>Insuffisance cardiaque droite avec symptômes (...)</i> peuvent également être utilisés en cas de FE préservée. 
{{</markdown>}}
<br>  
<br>
{{</article>}}
...
Le fait qu'il s'agisse d'une infection d'origine bactérienne ne justifie pas automatiquement le codage J15.8 <i>Autres pneumonies bactériennes</i>.
{{</markdown>}}
<br>  
<br>
{{</article>}}
